...
for trial in {1..100};do
	...
	## Mesolithic sample
        ...
        sed 's/.*/&\t '"$selec"'/' tmp/H12_mesolithic_NoNAhap.txt >> out/out_H12_mesolithic_NoNAhap.txt
	...
	## Mesolithic sample
        ...
        sed 's/.*/&\t '"$selec"'/' tmp/H12_mesolithicFull.txt >> out/out_H12_mesolithic.txt
	...
	######################################################################################
        ...
        sed 's/.*/&\t '"$selec"'/' tmp/H12_mesolithic_MD.txt >> out/out_H12_mesolithic_MD.txt
